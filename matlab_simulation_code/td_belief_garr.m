function results = td_belief_garr(x,O,T,trueState,params,update_OT)
...
results2 = results;
results = struct;
results.w1 = results1.w;
results.w2 = results2.w;
results.b = results1.b;
%results.b2 = results2.b;
results.rpe1 = results1.rpe;
results.rpe2 = results2.rpe;
results.rpe = vecnorm([results.rpe1,results.rpe2]');
results.value1 = results1.value;
results.value2 = results2.value;