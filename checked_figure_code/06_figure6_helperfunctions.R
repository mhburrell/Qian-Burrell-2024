...
require(reticulate)
require(tidymodels)
#create environment "conda create -n r-reticulate python=3.10 joblib h5py numpy scipy<1.12"; "conda activate r-reticulate" then "pip install pyrcca"
use_condaenv("C:\\Users\\Mark\\anaconda3\\envs\\r-reticulate\\python.exe")
source_python("06_figure6_run_cca.py")
...
do_cca <- function(data, ndim = 3, reg = 0., threshold = 0.95) {
  data |>
